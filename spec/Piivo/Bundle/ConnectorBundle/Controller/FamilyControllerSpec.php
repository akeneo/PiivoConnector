...
use Piivo\Bundle\ConnectorBundle\Controller\FamilyController;
...
class FamilyControllerSpec extends ObjectBehavior
{
    function let(
    ...
    {
        $this->shouldHaveType(FamilyController::class);
        $this->shouldBeAnInstanceOf(BaseApiFamilyController::class);
    }
}
