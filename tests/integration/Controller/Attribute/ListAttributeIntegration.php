...
class ListAttributeIntegration extends ApiTestCase
{
    ...
    public function testListTextAttributes()
    {
        ...
        $client->request('GET', 'api/rest/v1/attributes?search={"type":[{"operator":"IN","value":["pim_catalog_text"]}]}');
...
JSON;
    ...
    {
        $client = $this->createAuthenticatedClient();
        $client->request('GET', 'api/rest/v1/attributes?search={"type":[{"operator":"IN","value":["pim_catalog_image","pim_catalog_file"]}]}');
